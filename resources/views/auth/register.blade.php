                ...
                <x-auth-card>
                    ...
                    <form method="POST" action="{{ route('register') }}" style="text-align:right">
                        ...
                        <div class="mt-4">
                         ...
                         <!-- Phone  Address -->
                         <div class="mt-4">
                            <x-label for="email" :value="__('رقم الهاتف')" />
                        ...
                        <div class="mt-4" style="text-align:center">
                            <label class="mr-5"><input type="radio" name="gender" value="0" checked > إمرأة</label>
                            <label><input type="radio" name="gender" value="1"> رجل</label>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <x-button class="ml-4" style="background-color:#e83e8db6;">
                                {{ __('تسجيل جديد') }}
                            </x-button>
                        </div>
                    </form>
